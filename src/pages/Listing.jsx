...
const Listing = () => {
    ...
    const handlePhoneNumberClick = () => {
        const phoneNumber = listing.contact; // Assuming 'contact' contains the phone number
    ...
    return (
        <div>
            ...
            <main>
                { loading && <p className='text-center my- text-2xl'>Loading...</p> }
                { error && (
                    ...
                    <>
                        ...
                        <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                            <p className='text-2xl font-semibold'>
                                { listing.name } - PKR{ ' ' }
                                { listing.offer ? ( listing.discountPrice || listing.regularPrice ) : listing.regularPrice }
                            ...
                            <div className='flex gap-4'>
                                ...
                                { listing.offer && (
                                    <p className='bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md'>
                                        { listing.discountedPrice } PKR OFF
                                    </p>
                                ) }
                            </div>
